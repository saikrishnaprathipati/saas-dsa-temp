...
@Component
public class EncryptionHelper implements PasswordEncoder
{
	private static final Logger logger = LogManager.getLogger(EncryptionHelper.class);
	...
	public static String encrypt(String password)
	{
		try
		{
			if (password != null)
			{
				...
				byte[] encryptedBytes = cipher.doFinal((password == null) ? null : password.getBytes());
	...
	//Parameters swapped around to match Spring Security call to matches
